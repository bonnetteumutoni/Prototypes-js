...
function featureToggle(eatureName,isEnabled,userGroupAccess){
    this.eatureName=eatureName;
...
function freelancerTimeLog(freelancerName){
    this.freelancerName=freelancerName;
}
this.prototype.calculateEarnings=function(){
...
function orderManagement(customer,items,status){
    this.customer=customer;
    this.items=items;
    this.status=status;
}
orderManagement.prototype.orderProcess=function(){
